                ...
                .subscribe(new Consumer<RespBean>() {
                    ...
                    public void accept(RespBean respBean) throws Exception {
                        ...
                        if (resp.getTransactions() != null && resp.getTransactions().size() > 0){
                            ...
                            List<Token> addedToken = TokenHelper.getAddedTokens(mActivity, mAccount.getPublicKey());
                            for (int i = 0; i < list.size(); i++) {
                                RecordBean bean = list.get(i);
                                RecordEntity entity = new RecordEntity(bean, addedToken, mAccount.getAddress());
                                ...
                                if (entity.getRecordType() == RecordEntity.TYPE_RECEIVED &&
                                    ...
                                    RecordEntity entitySend = new RecordEntity(bean, addedToken, mAccount.getAddress());
