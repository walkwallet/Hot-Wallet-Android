...
public class DepositToContractActivity extends BaseThemedActivity implements View.OnClickListener {

    public static void launch(Activity from, String publicKey) {
        Intent intent = new Intent(from, DepositToContractActivity.class);
    ...
    private ActivityDepositToContractBinding mBinding;
